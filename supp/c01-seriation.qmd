...
Load the data and summarize row and column sums. Also create burial with only the counts using types as rownames. Finally create burial_pct with percentages.
